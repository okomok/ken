...
object MonadWriter {
    ...
    def apply[m <: Kind.Function1](implicit _M: MonadWriter[m#apply1]): Of[_M.WriteType, m#apply1] = _M

    def deriving[nt <: Kind.Newtype1](implicit _Nt: Newtype1[nt#apply1, nt#oldtype1], _M: MonadWriter[nt#oldtype1]): Of[_M.WriteType, nt#apply1] = new MonadWriter[nt#apply1] with MonadProxy[nt#apply1] {
    ...
    def weak[nt <: Kind.Newtype1](implicit _Nt: Newtype1[nt#apply1, nt#oldtype1], _M: MonadWriter[nt#apply1]): Of[_M.WriteType, nt#oldtype1] = deriving[Kind.coNewtype1[nt]](_Nt.coNewtype, _M)
}
