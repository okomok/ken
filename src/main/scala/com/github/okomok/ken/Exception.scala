...
object Exception extends ExceptionInstance with ExceptionShortcut {
    ...
    def deriving[nt <: Kind.Newtype0](implicit j: Newtype0[nt#apply0, nt#oldtype0, _], i: Exception[nt#oldtype0], k: Typeable[nt#apply0]): Exception[nt#apply0] = new Exception[nt#apply0] with TypeableProxy[nt#apply0] with ShowProxy[nt#apply0] {
        type e = nt#apply0
    ...
    def weak[nt <: Kind.Newtype0](implicit j: Newtype0[nt#apply0, nt#oldtype0, _], i: Exception[nt#apply0], k: Typeable[nt#oldtype0]): Exception[nt#oldtype0] = deriving[Kind.coNewtype0[nt]](j.coNewtype, i, k)
